...
import { toast } from 'react-toastify'; // If you're using react-toastify or another toast library
                                ...
                                <TableCell className="text-right cursor-pointer">
                                    <Popover>
                                        ...
                                        <PopoverContent className="w-32">
                                            ...
                                            <div onClick={() => deleteJob(job._id)} className='flex items-center gap-2 w-fit cursor-pointer mt-2 text-red-600'>
